...
CalCurve_df <- read.csv(here("TSQ_Frag_Metab_RAW", "ER3_149_Frag_Catalina_01_Cal03022022_output.csv"))


# Load in list that checks for calibration curve
cal_data_sum <- read.csv(here("1_TSQ_Frag_Metab_CalCurveQuant", "TSQ_Metab_CalSum.csv"))
...
BMIS.Data <- read.csv(here("0_TSQ_Frag_Metab_BMIS", "QC_BMIS_results_sum.csv")) |> 
...
spike_amounts <- read.csv(here("1_TSQ_Frag_Metab_CalCurveQuant", "spike_amount_calcurve.csv"))
...
metab_data <- read.csv(here("TSQ_Frag_Metab_RAW", "ER3_149_Frag_Catalina_01_03022022_output.csv")) |> 
...
cell_nos <- read.csv(here("1_TSQ_Frag_Metab_CalCurveQuant", "B_sample_info_loading_220116.csv")) |>
...
write.csv(metabs_data_cat, here("1_TSQ_Frag_Metab_CalCurveQuant", "metabs_data_cat.csv"))
...
write.csv(metabs_data_quant, here("1_TSQ_Frag_Metab_CalCurveQuant", "metabs_data_quant.csv"))
